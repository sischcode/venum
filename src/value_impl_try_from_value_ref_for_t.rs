...
// impl_try_from_value_ref_for_clone_type!(String, String); // implemented below, because we handle Value::None differently here! // TODO: not sure, if this is a good idea, though)
